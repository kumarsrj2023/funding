                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered {{ $table_name }}">
                                        <thead class="thead-dark">
                                            <tr class="table-main-header mb-0 text-center">
                                                <th colspan="4" class="text-center">Invoice Approval Checklist</th>
                                                <th colspan="3" class="text-center">Second Checker (Other Underwriter)
                                                </th>
                                            </tr>
                                            <tr class="table-sub-header text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="checklist-column column-2">
                                                    ...
                                                    <input type="hidden" name="checklist_items[{{ $index }}][checklist]"
                                                        ...
                                                        class="{{ $helper_class }}_checklist">
                                                </td>

                                                {{-- Completed column --}}
                                                @if(!in_array($index, $hiddenRows))
                                                <td class="completed-column column-3"
                                                ...
                                                {{-- Updated by column --}}
                                                <td class="updated-by-column column-4"
                                                    @if(isset($rowspanStructure[$index]))
                                                    rowspan="{{ $rowspanStructure[$index] }}" @endif>

                                                    @include('partials.updated-by', [
                                                    'timestamp' => $item['updated_at_first_checker'] ?? null,
                                                    'userId' => $item['logged_user_id_first_checker'] ?? null
                                                    ])
                                                </td>

                                                {{-- Second Checker Completed column --}}
                                                <td class="second-checker-completed-column column-5"
                                                    @if(isset($rowspanStructure[$index]))
                                                    rowspan="{{ $rowspanStructure[$index] }}" @endif>
                                                    <select
                                                        name="checklist_items[{{ $index }}][second_checker_completed]"
                                                        class="form-control {{ $helper_class }}_second_checker_completed input-field"
                                                ...
                                                {{-- Second Checker Updated by column --}}
                                                <td class="second-updated-by-column column-6"
                                                    @if(isset($rowspanStructure[$index]))
                                                    rowspan="{{ $rowspanStructure[$index] }}" @endif>

                                                    @include('partials.updated-by', [
                                                    'timestamp' => $item['updated_at_second_checker'] ?? null,
                                                    'userId' => $item['logged_user_id_second_checker'] ?? null
                                                    ])
                                                </td>
                                                @else
                                                ...
                                                {{-- Notes column --}}
                                                <td class="notes-column column-7">
                                    ...
                                    <table class="table table-bordered {{ $table_name }}">
                                        ...
                                        <tbody
                                            ...
                                            <tr>
                                                ...
                                                <td class="second-checker-completed-column column-4"
                                                    @if(isset($rowspanStructure[$index]))
                                                    rowspan="{{ $rowspanStructure[$index] }}" @endif>
                                                    <select
                                    ...
                                    <table class="table table-bordered {{ $table_name }}">
                                        ...
                                        <tbody x-data="rowHandler('once_funded', {{ json_encode($rowspanStructure) }})">
                                            ...
                                            <tr>
                                                ...
                                                <td class="{{ $helper_class }} column-2">
                                                    <input type="hidden"
                                                ...
                                                <td @if(isset($rowspanStructure[$index]))
                                                    rowspan="{{ $rowspanStructure[$index] }}" @endif
                                                    class="completed-column column-3">
                                                ...
                                                <td @if(isset($rowspanStructure[$index]))
                                                    rowspan="{{ $rowspanStructure[$index] }}" @endif
                                                    class="second-checker-completed-column column-4">
                                                    <select
                            ...
                            <div class="col-12 mt-3">
                                <button class="btn btn-custom me-1" type="submit" type="submit" id="submitButton"
                                    disabled>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', function (event) {
            ...
            Swal.fire({
                ...
                // If user clicked 'Yes, download it!'
