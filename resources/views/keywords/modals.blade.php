<div class="modal fade" id="keywords-import" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Import keywords by spreadsheet</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('keywords.import') }}" method="post" class="ajax-form-submit" enctype="multipart/form-data">
                ...
                <div class="modal-footer d-inline-block w-100">
                    <a href="{{ asset('files/keyword_import.xlsx') }}" class="download-sample-file text-success d-inline-block" download="">Download sample file</a>
...
<div class="modal fade" id="keywords-export" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Export keywords</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('keywords.export') }}" method="post" class="ajax-form-submit" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row g-2">
                        <p class="mb-0">Use <strong>ID</strong> column in order to import and update keyword without creating duplicate entries</p>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-custom btn-ajax-show-processing" type="submit">
                        ...
                        <span class="default-show">Export keywords</span>
                    </button>
                </div>
            </form>
        </div>
