@extends('index')
@section('title', Helper::getSiteTitle('Open Banking Payments'))
        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Open Banking Payments</li>
                </ol>
            </div>
            <h4 class="page-title">{{ !empty($business_info) && !empty($business_info->business_name) ? $business_info->business_name : 'Open Banking Payments' }}</h4>
        </div>
    </div>
</div>
<div class="row ">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="card no-lt-rt-pad">
                        {!! Helper::getDatatables(['Type', 'Amount', 'Payment Reference', 'Interval', 'Recurring Start Day', 'Recurring Expiry Date', 'Created At']) !!}
                    </div>
                </div>
            </div>
        </div>
...
@include('businesses.add.open-banking-payments.modals', ['id' => $id])
@endsection

@section('meta')
<meta name="remove-url" content="{{ route('businesses.open.banking.payments.remove') }}">
    ...
    function createTable()
    {
        ...
        table = $('.datatable').DataTable({
                    ...
                    "layout": {
                        ...
                        topEnd: function () {
                            return `<div class="dt-btns">
                                        <button type="button" class="btn btn-sm btn-custom" data-bs-toggle="modal" data-bs-target="#open-banking-payments-form-add">Add New</button>
                                    </div>`;
                        }
                    },
                    "ajax":
                    ...
                    "columns":[
                        ...
                        { "data": "recurring_start_day", "name":"recurring_start_day" },
                        { "data": "recurring_expiry_date", "name":"recurring_expiry_date" },
